...
class FillPermissionsForMatricula extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForMatricula constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            ...
            'admin.matricula.create',
            'admin.matricula.show',
            'admin.matricula.edit',
            'admin.matricula.delete',
            'admin.matricula.bulk-delete',
        ]);
