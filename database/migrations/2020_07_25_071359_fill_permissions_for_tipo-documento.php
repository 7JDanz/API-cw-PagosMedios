...
class FillPermissionsForTipoDocumento extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForTipoDocumento constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.tipo-documento',
            'admin.tipo-documento.index',
            'admin.tipo-documento.create',
            'admin.tipo-documento.show',
            'admin.tipo-documento.edit',
            'admin.tipo-documento.delete',
            'admin.tipo-documento.bulk-delete',
        ]);
