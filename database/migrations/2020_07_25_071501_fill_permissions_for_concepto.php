...
class FillPermissionsForConcepto extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForConcepto constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.concepto',
            'admin.concepto.index',
            'admin.concepto.create',
            'admin.concepto.show',
            'admin.concepto.edit',
            'admin.concepto.delete',
            'admin.concepto.bulk-delete',
        ]);
